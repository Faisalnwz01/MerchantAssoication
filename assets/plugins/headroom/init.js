    ...
    $(document).ready(function () {
        ...
        if($($headroomCla).length > 0){
            $($headroomCla).each(function(){
                ...
                $(window).scroll(function(){
                    ...
                    if ($this.hasClass($topBarStr)){
                        ...
                        if (scrollPos >  ctstartnavbar){
                            $this.addClass("navbar-scroll-top");
                            $bodyel.addClass("ct-navbar--small");
                            if (($bodyel).hasClass("ct-navbar--toInverse")){
                                $navbarel.addClass("navbar-inverse");
                            }
                            else{
                                if (($navbarel).hasClass("navbar-transparent")){
                            ...
                            $this.removeClass("navbar-scroll-top");
                            $bodyel.removeClass("ct-navbar--small");
                            if($scrollUpBoth || $scrollUpTopBar){
                                $this.css("top","auto");
                            }
                            if ((($navbarel).hasClass("navbar-transparent") && (($navbarel).hasClass("navbar-default"))) || (($navbarel).hasClass("navbar-transparent") && (($navbarel).hasClass("navbar-inverse")))){
                                $this.removeClass("navbar-default");
                                $this.removeClass("navbar-inverse");
                            }
                            if ((($navbarel).hasClass("navbar-default") && (($navbarel).hasClass("navbar-inverse")))){
                                $this.removeClass("navbar-inverse");
                            }
                        }
                    }
                ...
                var ctoffset = validatedata($this.attr("data-offset"), 105); //this is the offset when taken elements have to disappear
